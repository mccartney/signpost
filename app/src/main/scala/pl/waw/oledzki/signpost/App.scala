...
object App {
  ...
  val exampleBoard: Board = Board(
    ...
    cells = Map(
      ...
      (1, 1) -> Cell(None, Direction.SE),
      (2, 1) -> Cell(None, Direction.W),
      (3, 1) -> Cell(None, Direction.W),
      (4, 1) -> Cell(None, Direction.S),

      (0, 2) -> Cell(None, Direction.NE),
      (1, 2) -> Cell(None, Direction.SE),
      (2, 2) -> Cell(None, Direction.E),
      (3, 2) -> Cell(None, Direction.N),
      (4, 2) -> Cell(None, Direction.W),

      (0, 3) -> Cell(None, Direction.SE),
      (1, 3) -> Cell(None, Direction.E),
      (2, 3) -> Cell(None, Direction.E),
      (3, 3) -> Cell(None, Direction.E),
      (4, 3) -> Cell(None, Direction.N),

      (0, 4) -> Cell(None, Direction.N),
      (1, 4) -> Cell(None, Direction.NE),
      (2, 4) -> Cell(None, Direction.NW),
      (3, 4) -> Cell(None, Direction.E),
